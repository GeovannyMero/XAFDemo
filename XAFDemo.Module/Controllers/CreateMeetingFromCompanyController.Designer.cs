...
namespace XAFDemo.Module.Controllers
{
    partial class CreateMeetingFromCompanyController
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.actionCreateMeeting.CustomizePopupWindowParams += new DevExpress.ExpressApp.Actions.CustomizePopupWindowParamsEventHandler(this.actionCreateMetting_CustomizePopupWindowParams);
            // 
